...
class TestGenieAnalytics {
    ...
    async sendAnalytics(data) {
        // Try webhook endpoint first for real analytics
        try {
            const webhookUrl = 'https://api.github.com/repos/sjuberrafik-clgx/testgenie/dispatches';
            
            // Try to send to webhook/repository dispatch
            ...
            // Webhook failed, try alternative method
        }
        
        // Fallback: Try direct issue creation (will likely fail without auth)
        try {
            const issueUrl = 'https://api.github.com/repos/sjuberrafik-clgx/testgenie/issues';
            
            const issueData = {
                title: `[Analytics] ${data.action} - ${new Date().toISOString().split('T')[0]}`,
                body: `## 🧞‍♀️ TestGenie Analytics\n\n**Action**: ${data.action}\n**Platform**: ${data.platform}\n**Method**: ${data.installMethod || 'unknown'}\n**Timestamp**: ${data.timestamp}\n**Version**: ${data.version}\n\n*Auto-generated by TestGenie CLI*`,
